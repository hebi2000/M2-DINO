...
try:
    ...
    # Fallback for when running as a script or different structure
    from head.pixel_decoder import MSDeformAttnPixelDecoder
    from head.mask2former_transformer_decoder import MultiScaleMaskedTransformerDecoder

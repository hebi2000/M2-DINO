...
try:
    from .utils import get_norm, PositionEmbeddingSine, _get_clones, _get_activation_fn, MSDeformAttn
except ImportError:
    from head.utils import get_norm, PositionEmbeddingSine, _get_clones, _get_activation_fn, MSDeformAttn
